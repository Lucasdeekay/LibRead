...
urlpatterns = [
    ...
    path('login/forgot-password/<str:username>/retrieve-password/process', views.process_recovery_password,
         name='process_recovery_password'),
    path('account/retrieve-password/update-password', views.update_password,
         name='update_password'),
    path('account/<str:username>/retrieve-password/update-password/set-password', views.set_updated_password,
