...
urlpatterns = [
    ...
    path('login/forgot-password/<str:user>/retrieve-password/process', views.process_recovery_password, name='process_recovery_password'),
    path('login/forgot-password/<str:user>/retrieve-password/update', views.update_password, name='update_password'),
