...
urlpatterns = [
    ...
    path('login/forgot-password/<str:name>/retrieve-password', views.password_retrieval, name='password_retrieval'),
    path('login/forgot-password/<str:name>/retrieve-password/process', views.process_recovery_password, name='process_recovery_password'),
    path('account//<str:name>retrieve-password/update-password', views.update_password, name='update_password'),
    path('account/<str:name>/retrieve-password/update-password/set-password', views.set_updated_password, name='set_updated_password'),
