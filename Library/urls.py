...
urlpatterns = [
    ...
    path('account/forgot-password/<str:user>/retrieve-password/update-password', views.update_password,
         name='update_password'),
    path('account/forgot-password/<str:user>/retrieve-password/update-password/set-password', views.set_updated_password,
